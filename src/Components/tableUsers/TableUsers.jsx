...
const TableUsers = () => {
  ...
  const banAlert = (id, isDisable) => {
    Swal.fire({
      ...
      icon: "warning",
      title: !isDisable
        ? "Estas segura/o de banear al usuario?"
        : "Estas segura/o de desbanear al usuario?",
  ...
  const adminAlert = (id, isAdmin) => {
    Swal.fire({
      ...
      icon: "warning",
      title: !isAdmin
        ? "Estas segura/o de dar permisos de administrador al usuario?"
        : "Estas segura/o de quitar permisos de administrador al usuario?",
      showConfirmButton: true,
      position: "center",
    }).then(() => {
            ...
            <tr key={user.id}>
              ...
              <td className={styles.button_cont}>
                <button
                  ...
                  onClick={() => adminAlert(user.id, user.isAdmin)}
                >
