...
const RegistrationForm = () => {
    ...
    const handleChange = (event) => {
        ...
        !Object.values(errors).length ? setDisabledButton(false) : setDisabledButton(true);
    }
        ...
        <div className={styles.principalContainer}>
            <div className={styles.container}>
                ...
                <div className={styles.progressContainer}>
                    ...
                    <div className={styles.stepContainer}>
                        <p c className={currentPage >= 4 ? ` ${styles.p} ${styles.active}` : styles.p}>Contacto</p>
                        <div className={styles.containerNumberIcon}>
                            <div className={currentPage >= 4 ? `${styles.numberContainer} ${styles.lastNumberContainer} ${styles.active}` : `${styles.numberContainer} ${styles.lastNumberContainer}`}>
                                <span className={currentPage >= 4 ? `${styles.span} ${styles.active}` : styles.span}>4</span>
                            </div>
                            <h1 className={currentPage >= 4 ? `${styles.iconCheck} ${styles.active}` : styles.iconCheck}>
                                <CheckIcon />
                            </h1>
                        </div>
                    </div>
                    ...
                    <form className={styles.form} onSubmit={handleSubmit}>
                        <div className={styles.containerPage} style={{ marginLeft: `${firstMarginLeft}%` }}>
                            ...
                            <div className={styles.field}>
                                ...
                                <input type="text" className={styles.input} name="name" value={infoUser.name} onChange={handleChange} />
                                {errors.name && <p className={styles.error}>{errors.name}</p>}
                            </div>
                            <div className={styles.field}>
                                <label className={styles.label}>Apellido</label>
                                <input type="text" className={styles.input} name="lastName" value={infoUser.lastName} onChange={handleChange}/>
                        ...
                        <div className={styles.containerPage} >
                            ...
                            <div className={styles.field}>
                                ...
                                <input type="text" className={styles.input} name="dni" value={infoUser?.dni} onChange={handleChange} />
                            </div>
                            <div className={styles.field}>
                                <label className={styles.label}>Dirección</label>
                                <input type="text" className={styles.input}  name="address" value={infoUser.address} onChange={handleChange} />
                        ...
                        <div className={styles.containerPage}>
                            ...
                            <div className={styles.field}>
                                ...
                                <input type="text" className={styles.input} disabled={true} value={user?.email} />
                            </div>
                            <div className={styles.field}>
                                ...
                                <PhoneInput country={'co'} inputProps={{ className: styles.inputTelefono }} containerClass={styles.containerClass}
                                    dropdownClass={styles.dropdown} name='phone' value={infoUser.phone} onChange={handlePhoneChange} />
                            </div>
                            <div className={`${styles.field} ${styles.btns}`}>
                                <button className={styles.button} onClick={handlePrevClick}>Atrás</button>
                                <button type='submit' className={disabledButton ? `${styles.button} ${styles.disabled}` : styles.button} disabled={disabledButton}>Enviar</button>
                            </div>
                        </div>
                    </form>
                </div>
