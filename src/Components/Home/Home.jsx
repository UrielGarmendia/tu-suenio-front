    ...
    <div className={styles.principal}>
      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.textContainer}>
          ...
          <p>
            Ahorrar te permite tener un colchón de dinero disponible para
            emergencias inesperadas, como gastos médicos, reparaciones de
            automóviles o pérdida de empleo. Esto evita que te endeudes o te
            veas en situaciones financieras difíciles; tambien Ahorrar te ayuda
            a trabajar hacia metas financieras a corto y largo plazo, como
            comprar una casa, pagar la educación de tus hijos, tomar unas
            vacaciones soñadas o jubilarte cómodamente.
          </p>
      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.textContainer}>
          ...
          <p>
            Un plan de ahorro te impulsa a ser disciplinado con tus finanzas
            personales. Al asignar una parte de tus ingresos para el ahorro de
            manera regular, desarrollas hábitos financieros saludables y evitas
            el gasto excesivo; Ahorrar según un plan te brinda seguridad
            financiera. Sabes que tienes recursos disponibles para lidiar con
            imprevistos y para alcanzar tus metas financieras a largo plazo.
            Esto reduce el estrés relacionado con las preocupaciones
            financieras.
          </p>
          <div>
            <img
